    ...
    run_order = [
        ...
        },
        {
            ...
            "mcp_sequence": [
                ...
                "board_safety_refresh only if the stable map is missing or invalid",
                "board_validate only if this run lacks a live identity proof",
        ...
        },
        {
            ...
            "mcp_sequence": [
                ...
                "do not refresh after an ordinary build or contained application flash",
                "disconnect and reconnect",
            ],
        ...
        "preserved_destructive_evidence": {
            "m7_nucleo_application_flash_and_refresh": {
                ...
                "reuse_scope": [
                    ...
                    "historical refresh behavior only; v2 uses direct per-flash artifact containment",
                ],
            },
