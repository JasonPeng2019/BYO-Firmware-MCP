...
$root = "C:\Users\Jason\Documents\Jason\FirmCLI\acceptance-wide-gpt-5.6-luna-20260718-r4"
$repo = "C:\Users\Jason\Documents\Jason\FirmCLI\BYO-Server"
$prompt = Get-Content -LiteralPath "$repo\docs\evidence\wide-acceptance-gpt-5.6-luna-medium-2026-07-18-prompt.md" -Raw
...
$args = @(
  ...
  'exec','--ignore-user-config','--ignore-rules','--ephemeral','--json','--output-last-message',"$root\journey-final.txt",'-'
)
