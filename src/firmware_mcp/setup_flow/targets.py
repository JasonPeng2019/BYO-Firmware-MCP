...
class TargetResolver:
    ...
    def resolve_detection(
        ...
        *,
        ...
        unresolved = (
            "No exact provider target was auto-detected for the exact MCU part number."
            if not exact
        ...
        request = make_research_request(
            ...
            requested_fields=("target", "evidence", "reasoning_summary"),
...
class ProfileCommitCoordinator:
    ...
    def commit_core(
        ...
        *,
        ...
        target = staged.profile.board.target
        try:
