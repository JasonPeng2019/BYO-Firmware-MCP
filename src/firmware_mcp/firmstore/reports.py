...
class ReportWriter:
    ...
    def paths(
        self,
        report_type: Literal["setup", "validation", "recovery"],
        attempt_id: str,
    ) -> ReportPaths:
    ...
    def create_recovery(self, attempt_id: str, fields: Mapping[str, Any]) -> ReportPaths:
        return self.create("recovery", attempt_id, fields)

    def append_recovery_event(self, attempt_id: str, event: Mapping[str, Any]) -> Path:
        return self.append_event("recovery", attempt_id, event)
