...
MANIFEST_OWNER = "byo-firmware-mcp-artifact-collector"
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            # The retained staging path is material recovery evidence; never
            # erase this secondary failure behind the build/artifact failure.
            attach_cleanup_error(
                primary, f"artifact staging removal (retained path: {stage})", cleanup
            )
        raise
