...
Implement every item in `/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/plan.md`, taking the one-time read-only
`/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/plan-review.md` as risk/test guidance, then fix failures from the latest neutral
`/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/state/test_report.md` on later turns. Inspect the repository and make the smallest
...
- `/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/state/spec_test_cmd` or `regression_test_cmd`;
...
- Plan: /mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/plan.md
- One-time plan review: /mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/plan-review.md
- Reviewed plan amendments, if any: /mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/plan-amendments.md
- Design-charter checkpoint log: /mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/DESIGN_CHARTER_CHECKS.md
- Latest neutral report: /mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/state/test_report.md
- Runtime state: /mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/A21-write-memory-coherence/state
...
## Main-accepted independent diff-review follow-up

Read `.change-loop/fresh-suite/A21-write-memory-coherence/diff-review.last-message.md`.
Address its single actionable finding under already-planned CL-003 only: the registered FastMCP
public `server.py::write_memory` docstring must teach when to use symbol versus justified raw
fallback, every parameter and unit/allowed width, one realistic invocation example, the return
shape/success limit, common refusal/failure modes, and concrete recovery, while retaining the
already-correct lifecycle contract. Keep the public signature, permission model, plan schema, and
all runtime behavior unchanged. Do not edit tests or gate files.
## Registered-descriptor correction

The regression tester proved the actual FastMCP descriptor is sourced from
`memory_tool_handlers["write_memory"].__doc__`, not the wrapper docstring. Read the current neutral
report and update only the handler docstring under CL-003 so the registered description contains
the same complete public contract, including the Layer-2 return shape and concrete refusal/failure
details. Keep runtime behavior and every public signature unchanged; do not edit tests or gate
files.
