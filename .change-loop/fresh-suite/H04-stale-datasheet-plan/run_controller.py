...
COMMAND = (
    "CL_RUNTIME_DIR=.change-loop/fresh-suite/H04-stale-datasheet-plan "
...
with LOG.open("w", encoding="utf-8", errors="replace") as output:
    ...
    state: dict[str, object] = {
        ...
        "started_utc": now(),
        "runtime": ".change-loop/fresh-suite/H04-stale-datasheet-plan",
        "models": {
            "doer": "gpt-5.6-terra",
        ...
        "approval": "Codex exec noninteractive; hardware actions prohibited by role prompts",
    }
    write_status(state)
