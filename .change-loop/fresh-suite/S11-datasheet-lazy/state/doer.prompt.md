...
Implement every item in `/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/S11-datasheet-lazy/plan.md`, taking the one-time read-only
`/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/S11-datasheet-lazy/plan-review.md` as risk/test guidance, then fix failures from the latest neutral
`/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/S11-datasheet-lazy/state/test_report.md` on later turns. Inspect the repository and make the smallest
...
- `/mnt/c/Users/Jason/Documents/Jason/FirmCLI_Tester/Firmware-Test-Manual/MCP-Trial-3/BYO-Firmware-MCP/.change-loop/fresh-suite/S11-datasheet-lazy/state/spec_test_cmd` or `regression_test_cmd`;
